...
def compare_faces(encod1, encod2):
    match = ((face_recognition.face_distance(encod1, encod2)) <= tolerance)
    return match


# code from site https://www.analyticsvidhya.com/blog/2021/06/learn-how-to-implement-face-recognition-using-opencv-with-python/
'''
